...
import {ArbitrageFlashSwap} from "../src/arbitrageUniswapFlashSwap.sol";
...
contract UniswapArbitrageTest is Test {
    ...
    ArbitrageFlashSwap private flashSwap;

    uint256 private constant DAI_AMOUNT_IN = 10 * 1e18;

    function setUp() public {
        flashSwap = new ArbitrageFlashSwap();

        // create an arbitrage opportunity: make dai WETH on pool0
    ...
    function testFlash_Swap() public {
